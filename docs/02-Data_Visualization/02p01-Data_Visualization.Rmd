...
<!--
pagedown::chrome_print("~/Dropbox/Teaching/02-Brown Courses/CEMA0907-Statistics in the Real World [ONLINE]/Content/02-Data_Visualization/02p01-Data_Visualization.html")
-->
...
movies <- read_csv("~/Dropbox/Teaching/02-Brown Courses/CEMA0928-Statistics in the Real World [ONLINE]/Data/movies.csv")
...
- **Numerical**
    - Examples: *continuous* (e.g., temperature), *discrete* (e.g., MATH 228 enrollment)
